...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            service = (ServiceEjbRemote) ctx.lookup("ejb:/appejb-remote/ServiceEjb!com.k1rard.webpp.ejb.service.ServiceEjbRemote?stateful");
            service2 = (ServiceEjbRemote) ctx.lookup("ejb:/appejb-remote/ServiceEjb!com.k1rard.webpp.ejb.service.ServiceEjbRemote?stateful");
