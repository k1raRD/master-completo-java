                ...
                <c:forEach items="${productos}" var="p">
                    <tr>
                        ...
                        <c:if test="${username.present}">
                            ...
                            <td><a class="btn btn-sm btn-danger" onclick="return confirm('Estas seguro que deseas eliminar?');" href="${pageContext.request.contextPath}/productos/eliminar?id=${p.id}">Eliminar<a/></td>
                        </c:if>
                    </tr>
                </c:forEach>
            </table>
