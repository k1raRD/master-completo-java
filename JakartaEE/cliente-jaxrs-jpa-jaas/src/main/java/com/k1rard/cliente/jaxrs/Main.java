...
import com.k1rard.cliente.jaxrs.models.Instructor;
...
public class Main {
    public static void main(String[] args) {
        ...
        WebTarget rootUri = client.target("http://localhost:8080/webapp-jaxrs-jpa-jaas/api").path("/cursos");

        rootUri.register(new BasicAuthentication("admin", "Admin12345"));
