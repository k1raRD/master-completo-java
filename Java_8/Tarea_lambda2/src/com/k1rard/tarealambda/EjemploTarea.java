...
public class EjemploTarea {
    public static void main(String[] args) {
        ContadorPalabras contador = frase -> {
            // Se limpia la frase y se deja todo en minusiculas
            // Luego se convierte en un array para podeer iterarlo
          String[] arreglo =  frase.replace(",","")
            ...
            // definimos dos variables importantes la palabra mas repetida y el max o cantidad de
            // veces que se repite la palabra
            int max = 0;
            String palabra = null;
            ...
            // finalmente devolvemos el resultado de la palabra mas repetida y
            // el  numero de veces que se repite en un Map
        ...
        contador.contarPalabras("Yo ni te conozco, ni te he visto, " +
                        "ni se tu nombre, ni te hablaré, ni me interesas.")
